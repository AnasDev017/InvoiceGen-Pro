  ...
  const [verificationCode, setVerificationCode] = useState("");
    ...
    useEffect(() => {
      const fetchProfile = async () => {
        try {
          const res = await axios.get(`${baseUrl}/auth/api/me`, { withCredentials: true });
    ...
    const handleUpdateProfile = async (e) => {
      ...
      setIsUpdating(true);
      try {
        await axios.post(`${baseUrl}/auth/updateProfile`, {
          newName,
          newPassword,
    ...
    const handlePhotoUpload = async (e) => {
      ...
      try {
        ...
        await axios.post(`${baseUrl}/auth/uploadProfilePhoto`, formData, {
